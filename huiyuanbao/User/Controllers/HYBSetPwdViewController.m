...
- (void)viewDidLoad {
    ...
    [_okBtn setTitle:@"保存并注册" forState:UIControlStateNormal];
    _okBtn.titleLabel.font = [UIFont systemFontOfSize:18.0f];
    [_okBtn addTarget:self action:@selector(regs) forControlEvents:UIControlEventTouchUpInside];
