...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        address.text = @"地址: 南京市鼓楼区丰台南路129号";
...
- (void)setStoreBaseInfo:(HYBStoreBaseInfo *)storeBaseInfo
{
    [self setNeedsLayout];
}


+ (CGSize)calculateCellSizeWithSummary:(HYBStoreBaseInfo *)storeBaseInfo containerWidth:(CGFloat)containerWidth
{
