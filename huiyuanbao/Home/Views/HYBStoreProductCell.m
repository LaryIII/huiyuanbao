...
- (void)setProduct:(HYBStoreProduct *)product
{
    _product = product;
    int padding = 8;
    ...
    productName.text = _product.productName;//@"牛肉水饺 [红包有优惠]";
    ...
    zhuying.text = _product.remark;//@"项目基本简介: 接口获取...";
    ...
    info1.text = _product.productPrice;//@"￥12.00";
