...
- (void)setXiaofeoRecord:(HYBXiaofeiRecord *)xiaofeiRecord
{
    ...
    storeTitle.text = _xiaofeiRecord.game_name;//@"消费";
    ...
    time.text = _xiaofeiRecord.order_time;//@"02-30 18:00";
    ...
    NSString *statusText = @"";
    switch ([_xiaofeiRecord.status integerValue]) {
        case 0:
            statusText = @"处理中";
            break;
        case 1:
    ...
    youvalue.text = [NSString stringWithFormat:@"￥%@", _xiaofeiRecord.rebate_money];//@"￥0.00";
    ...
    alivalue.text = [NSString stringWithFormat:@"￥%@", _xiaofeiRecord.total_money];//@"￥3.00";
