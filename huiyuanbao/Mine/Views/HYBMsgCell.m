...
//    if(_msg.image && ![_msg.image isEqualToString:@""]){
//        [[CXImageLoader sharedImageLoader] loadImageForURL:[NSURL URLWithString:[IMG_PREFIX stringByAppendingString:_msg.image]] image:^(UIImage *image, NSError *error) {
...
//    }
    ...
    storeTitle.text = _msg.image;//@"蓝湾咖啡";
//    storeTitle.lineBreakMode = UILineBreakModeCharacterWrap;
    storeTitle.numberOfLines = 2;
...
//    }];
    ...
    platform.text = [NSString stringWithFormat:@"%@ %@", _msg.muname,_msg.senddate];//@"惠员包平台 01-26 15:00"
