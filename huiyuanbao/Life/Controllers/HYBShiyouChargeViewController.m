...
- (void)viewDidLoad {
    ...
    _pays = @[@{@"name":@"100元",@"money":@"100",@"id":@"64349102"},@{@"name":@"500元",@"money":@"500",@"id":@"64349102"},@{@"name":@"1000元",@"money":@"1000",@"id":@"64349102"}];
...
-(void)btn2clicked:(UIButton *)sender{
    ...
    _totalMoney = [_pays[label-20001] objectForKey:@"money"];
    _cardid = [_pays[label-20001] objectForKey:@"id"];
}
